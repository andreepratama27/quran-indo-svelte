<script lang='ts'>
  import { todayVerse } from '$lib/stores/todayVerse'
</script>

<div class="relative flex flex-col items-center justify-center min-h-56 mb-8 overflow-hidden text-center bg-violet-600 shadow-skew py-4 px-2" id="surah-intro">
